...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter { // Il faut hériter de WebSecurityConfigurerAdapter
	...
	// Configurer DaoAuthenticationProvider
	@Bean
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.userDetailsService(getCustomAuthentificationService());
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/user/**").hasRole("USER") // Le role USER accèdent aux requete commençant
																			// par /user/
